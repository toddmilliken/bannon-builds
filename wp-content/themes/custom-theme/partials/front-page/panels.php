			...
			<div class="panel panel-<?php echo $panel_counter; ?>" id="panel-<?php echo $panel_counter; ?>">
				...
				<?php if ( $bg_img = $panel['hp_bg_img'] ) :	?>
					<div class="panel-bg picturefill-background">
						<span data-src="<?php echo $bg_img['sizes']['desktop']; ?>" data-media="(min-width: 1025px)"></span>
						<span data-src="<?php echo $bg_img['sizes']['tablet']; ?>" data-media="(max-width: 1024px)"></span>
